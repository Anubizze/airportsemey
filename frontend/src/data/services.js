 ...
 * images: [{ src: '/services/cafe-aspan-1.webp', alt: { ru: '...', kz: '...', en: '...' } }]
 */
export const AIRPORT_SERVICES = [
  {
    id: 'cafe-aspan',
    icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z',
    title: { ru: 'Кафе «Аспан»', kz: '«Аспан» кафесі', en: 'Café Aspen' },
    ...
    details: {
      ru: 'Кафе «Аспан» расположено на втором этаже терминала. Здесь можно перекусить до вылета или после прилёта: горячие блюда, кофе, выпечка и прохладительные напитки. Уютная зона для отдыха пассажиров.',
      kz: '«Аспан» кафесі терминалдың 2-қабатында орналасқан. Ұшудан бұрын немесе қонудан кейін тамақтануға болады: ыстық тағамдар, кофе, нан-тоқаш және сусындар. Жолаушыларға арналған ыңғайлы демалыс аймағы.',
      en: 'Café Aspen is on the second floor of the terminal. Passengers can enjoy hot meals, coffee, pastries and cold drinks before departure or after arrival in a comfortable seating area.',
    },
    images: [],
  },
  {
