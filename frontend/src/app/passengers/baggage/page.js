...
const HISKY_RULES_URL = 'https://hisky.kz/accordeon-page/pravila-perevozok/';
...
function getAirlineRules(p) {
  return [
    ...
    },
    {
      ...
      logo: hiSkyLogo,
      links: [
        { label: p.airlineLinks.hiskyRules, href: HISKY_RULES_URL },
        { label: p.airlineLinks.hiskyBaggage, href: HISKY_RULES_URL },
        { label: p.airlineLinks.hiskyAnimals, href: HISKY_RULES_URL },
      ],
    },
  ];
}
...
const hiSkyRuleLink = { name: 'Hi Sky', logo: hiSkyLogo, href: HISKY_RULES_URL };
