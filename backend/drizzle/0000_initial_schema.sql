...
CREATE TYPE "public"."flight_direction" AS ENUM('arrival', 'departure');
CREATE TYPE "public"."flight_status" AS ENUM('scheduled', 'checkin', 'boarding', 'departed', 'delayed', 'cancelled', 'landing', 'landed', 'arrived');
CREATE TYPE "public"."user_role" AS ENUM('superadmin', 'dispatcher', 'news_editor');
...
CREATE UNIQUE INDEX IF NOT EXISTS "flight_subscriptions_flight_email_unique" ON "flight_subscriptions" USING btree ("flight_id","email");
