        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center max-w-2xl mx-auto">
          {AIRLINES.map((airline) => (
            <a
              ...
              className="flex-1 rounded-2xl border overflow-hidden shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
              ...
              <div className="bg-white px-5 py-4 text-center border-t flex items-center justify-center gap-2" style={{ borderColor: airline.border }}>
                <div>
                  ...
                  <div className="text-sm text-gray-400 mt-0.5">
                    {airline.key === 'flyarystan' ? t.partners.flyarystanDesc : t.partners.scatDesc}
                  </div>
                </div>
