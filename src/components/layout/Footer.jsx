        ...
        <div className="mt-10 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row gap-6 md:gap-10 mb-6">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm text-blue-200">г. Семей, ул. Комплекс Аэровокзала, д. 52798</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <a href="tel:87222360033" className="text-sm text-blue-200 hover:text-white transition-colors">8 (7222) 36-00-33</a>
            </div>
            <div className="flex items-center gap-3">
              <svg className="w-5 h-5 text-blue-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <a href="mailto:airportsemey@mail.kz" className="text-sm text-blue-200 hover:text-white transition-colors">airportsemey@mail.kz</a>
            </div>
          </div>
